...
for (i=0;i<people.length;i++){
    if (people[i].country === "Canada" || people[i].country === "Mexico" ) {
        console.log(people[i].name)
        console.log(people[i].phone)
        // console.log(people[i].country) 
}
...
for (i=0;i<people.length;i++){
    if (people[i].country === "Canada" || people[i].country === "Mexico" || people[i].country ==="Ireland" ) {
        console.log(people[i].name)
        console.log(people[i].phone)
        // console.log(people[i].country) 
}
